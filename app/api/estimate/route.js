...
const SYSTEM =
  ...
  "name is a clean display name. note is a short neutral line under 12 words.";
...
export async function POST(req) {
  ...
  try {
    ...
    console.log("MiniMax SUCCESS:", MODEL);
